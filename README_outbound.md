...
- Provider readback found published V67 and an unpublished V68 draft with identical agent settings, global prompt, nodes, and tools. V68 was intentionally not published because it adds no behavior.

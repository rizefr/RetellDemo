...
- Retell outbound agent and Conversation Flow are on the presentation-ready publish:
  - agent: `agent_4aa8074d7eabe311109ed6da89`, published version `21`
  - Conversation Flow: `conversation_flow_bebdceabc801`, version `21`
...
- Retell V21 readback confirms Paul, speed `0.88`, the `650 ms` start delay, seven wrapped custom tools, voicemail hangup, the virtual-assistant wording, honest AI answer, explicit phone/email confirmation, and separate call-purpose scripts. Native no-call simulations should be rerun in Retell before the next live call.

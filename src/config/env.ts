...
const envSchema = z.object({
  ...
  RETELL_BASE_URL: z.string().optional().default("https://api.retellai.com"),
  RETELL_DELETE_DUPLICATES: booleanFromString.default(false),
  RETELL_SOP_REPS: z.coerce.number().int().positive().default(1),
  RETELL_SOP_SCENARIOS: z.string().optional().default(""),
  RETELL_TEST_FLOW_VERSION: z.string().optional().default(""),
  RETELL_TEST_LLM_ID: z.string().optional().default(""),
  RETELL_TEST_LLM_VERSION: z.string().optional().default(""),

  APP_BASE_URL: z.string().optional().default(""),
  PRODUCTION_BASE_URL: z.string().optional().default(""),
  INBOUND_BASE_URL: z.string().optional().default(""),
  CANDIDATE_BASE_URL: z.string().optional().default(""),
  ...
  SERVICE_AREA_ZIPS: z.string().optional().default(""),
  SERVICE_AREA_CITIES: z.string().optional().default(""),
  SERVICE_AREA_CENTER_LAT: z.string().optional().default(""),
  SERVICE_AREA_CENTER_LNG: z.string().optional().default(""),
  SERVICE_AREA_RADIUS_MILES: z.string().optional().default(""),
